...
export const metadata: Metadata = {
  title: "AI 채팅 도파민 — Zeta, Crack, LoveyDovey 비교 | 도파민 사이트",
  description: "Zeta, Crack, LoveyDovey 등 한국 AI 채팅 앱이 월 100만 달러 매출. AI 남친/여친, 가상 연애가 주는 도파민과 한계 분석.",
  robots: { index: true, follow: true },
  alternates: { languages: { "ko-KR": "https://virtual-break-room-318.vercel.app/dopamine/ai-chat" } },
  openGraph: {
    title: "AI 채팅 도파민 — Zeta, Crack, LoveyDovey 비교 | 도파민 사이트",
    description: "Zeta, Crack, LoveyDovey 등 한국 AI 채팅 앱이 월 100만 달러 매출. AI 남친/여친, 가상 연애가 주는 도파민과 한계 분석.",
    url: "https://virtual-break-room-318.vercel.app/dopamine/ai-chat",
    siteName: "담배런",
    locale: "ko_KR",
    type: "article",
  },
  ...
  "itemListElement": [{"@type": "ListItem", "position": 1, "name": "담배런", "item": "https://virtual-break-room-318.vercel.app"}, {"@type": "ListItem", "position": 2, "name": "도파민 사이트 TOP 10", "item": "https://virtual-break-room-318.vercel.app/dopamine"}, {"@type": "ListItem", "position": 3, "name": "ai-chat"}]
    ...
    <main style={{maxWidth:700,margin:"0 auto",padding:"40px 20px 60px",background:"#0a0a0b",minHeight:"100vh"}}>
      ...
      <div style={{marginBottom:40,display:"flex",flexWrap:"wrap",gap:6}}>
        <span key="AI 채팅" style={{background:"rgba(212,168,96,0.15)",color:"#d4a860",fontSize:11,padding:"3px 8px",borderRadius:4,marginRight:4,marginBottom:4,display:"inline-block"}}>#AI 채팅</span><span key="AI 남친" style={{background:"rgba(212,168,96,0.15)",color:"#d4a860",fontSize:11,padding:"3px 8px",borderRadius:4,marginRight:4,marginBottom:4,display:"inline-block"}}>#AI 남친</span><span key="AI 여친" style={{background:"rgba(212,168,96,0.15)",color:"#d4a860",fontSize:11,padding:"3px 8px",borderRadius:4,marginRight:4,marginBottom:4,display:"inline-block"}}>#AI 여친</span><span key="가상 연애" style={{background:"rgba(212,168,96,0.15)",color:"#d4a860",fontSize:11,padding:"3px 8px",borderRadius:4,marginRight:4,marginBottom:4,display:"inline-block"}}>#가상 연애</span><span key="Zeta" style={{background:"rgba(212,168,96,0.15)",color:"#d4a860",fontSize:11,padding:"3px 8px",borderRadius:4,marginRight:4,marginBottom:4,display:"inline-block"}}>#Zeta</span><span key="Crack" style={{background:"rgba(212,168,96,0.15)",color:"#d4a860",fontSize:11,padding:"3px 8px",borderRadius:4,marginRight:4,marginBottom:4,display:"inline-block"}}>#Crack</span><span key="도파민 사이트" style={{background:"rgba(212,168,96,0.15)",color:"#d4a860",fontSize:11,padding:"3px 8px",borderRadius:4,marginRight:4,marginBottom:4,display:"inline-block"}}>#도파민 사이트</span>
      </div>
